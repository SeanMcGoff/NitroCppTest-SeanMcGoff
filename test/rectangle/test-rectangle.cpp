...
TEST(RectangleTest, isChildOf) {
  Rectangle r1 = Rectangle(0,0,100,100);
  Rectangle r2 = Rectangle(100,100,100,100);
  Rectangle r3 = Rectangle(0,0,50,50,"",{&r1});
...
TEST(RectangleTest, stringConversionOperator2) {
  ...
  Rectangle r = Rectangle(140,160,210,20,"",{&r1,&r3});
  EXPECT_EQ(std::string(r),s);
}
